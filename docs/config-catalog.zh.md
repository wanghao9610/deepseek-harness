...
来源：[`packages/tui/tui/src/config.ts:129`](../packages/tui/tui/src/config.ts)
...
来源：[`packages/bundle/tui-app/src/index.ts:36`](../packages/bundle/tui-app/src/index.ts)
...
- `@deepseek-ai/dsh-ssh-launch`（[`packages/boot/ssh-launch/src/index.ts`](../packages/boot/ssh-launch/src/index.ts)）
