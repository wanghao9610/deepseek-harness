...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/boot/ssh-launch': { kind: 'none', reason: 'Plans a process launch for a shell outside any harness context; the launched runtime\'s own plugins own every model-visible consequence.' },
