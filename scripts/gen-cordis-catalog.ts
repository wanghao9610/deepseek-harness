...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  tuiGoodbyeMessage: 'not a service: app-provided boot-context value (string | undefined) naming the command that returns to this session — packages/tui/tui/README.md owns this app contract',
  tuiInitialSkill: 'not a service: app-provided boot-context value (string | undefined) seeding a fresh session\'s first turn — packages/tui/tui/README.md owns this app contract',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TuiOverlayRequest: 'terminal overlay request is owned by packages/tui/tui/src/extension/types.ts',
  TuiOverlaySession: 'terminal overlay handle is owned by packages/tui/tui/src/extension/types.ts',
  TuiPromptValueHandle: 'terminal prompt-value registration is owned by packages/tui/tui/src/prompt.ts',
  TuiPromptUnsubscribe: 'terminal prompt-change subscription disposer is owned by packages/tui/tui/src/prompt.ts',
