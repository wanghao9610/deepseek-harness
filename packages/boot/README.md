...
The channel-neutral boot libraries shared by `apps/cli`, the desktop shell, and the [`examples/`](../examples/README.md) demo bins.
...
| [`ssh-launch/`](ssh-launch/README.md) | Launch planning for a runtime served from another host over SSH: connection validation, the `ssh` command line and its remote script, and failure diagnosis | (library for the shells) |
